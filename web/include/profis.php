...
if ($ind==0) {
   ...
   // echo $line.'<br>';
    ...
    public function build_d3($line, $ateco)
    {
        ...
        $ris = $ris .'D4'.$cd_profis.'                            '.date('Y').'01479110     A001Acquisti                                          0000000                                                               1000000                                                                                                                                            000   00010    2V0010         0000 0000         00 0000         0 0000          0000         0 0000         00 0000         0 0000         0000 0000          000                                  0                                                                     2021.7  A'. PHP_EOL;
        $ris = $ris .'D4'.$cd_profis.'                            '.date('Y').'01479110     V001Vendite                                           0000000                                                               1002000                                                                                                                                            000   00010    2 0000         0000 0000         00 0000         0 0000          0000         0 0000         00 0000         0 0000         0000 0000          000                                  0                                                                     2021.7  A'. PHP_EOL;
        $ris = $ris .'D4'.$cd_profis.'                            '.date('Y').'01479110     C001Corrispettivi                                     0000000                                                               1002000                                                                                                                                            000   00010    0 0000         0000 0000         00 0000         0 0000          0000         0 0000         00 0000         0 0000         0000 0000          000                                  0                                                                     2021.7  A'. PHP_EOL;
        $ris = $ris .'D8'.$cd_profis.'                            '.date('Y').'1          0000101202201331122022300000013489331002                 0          00001012022012311220222000000                            0000000                                                                                                                                                                                                                                                                                                                                                                                                                      2021.7  A'. PHP_EOL;
        $ris = $ris .'DP'.$cd_profis.'                            '.date('Y').'01479110     1222100                                                            0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    2021.7  A'. PHP_EOL;
        $ris = $ris .'DE'.$cd_profis.'                            '.date('Y').'01479110     00000USCRF00000  0000        00                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         2021.7  A'. PHP_EOL;
        $ris = $ris .'DR'.$cd_profis.'                            '.date('Y').'00000000100110000000000000000 000000000000000000000000010000000000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                2021.7  A'. PHP_EOL;
        $ris = $ris .'DG'.$cd_profis.'                            '.date('Y').'01479110     10200000002022010                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       2021.7  A'. PHP_EOL;
